 ...
 */
export function revealAnimation(element, className = { "disabled": "is-hidden", "enabled": "is-appear" }) {
 ...
 * @param className The class name to use
 */
export default function revealAnimationForElements(elements, className = { "disabled": "is-hidden", "enabled": "is-appear" }) {
